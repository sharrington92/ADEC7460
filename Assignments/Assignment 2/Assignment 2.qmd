...
However, gas and diesel prices aren't known for true forecasts and the test set must be adjusted for that. These prices will be estimated using a vector autoregression (VAR). 
...
Since gas and diesel prices are very difficult to forecast, we will consider a scenario forecasting approach with a low price (20th percentile), medium price (point estimate), and high price (80th percentile) scenarios.  
